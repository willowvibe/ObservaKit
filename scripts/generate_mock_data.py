...
def generate_metadata():
    ...
    for model in [
        VolumeRecord, FreshnessRecord, CheckResult, PipelineRun,
        SchemaDiff, SchemaSnapshot, ColumnProfile, CheckSuppression,
    ]:
    ...
    checks_def = {
        ...
        "public.products": [
            ...
            ("category must not be null",         "great_expectations", False, "12 rows with null category"),
        ],
        "analytics.daily_revenue": [
