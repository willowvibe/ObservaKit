...
class TestStage3Resiliency:
    ...
    def test_dispatch_alert_logs_to_db(self, db_session, monkeypatch):
        ...
        monkeypatch.setattr("alerts.base.get_alert_dispatcher", lambda *args, **kwargs: mock_dispatcher)
        # Mock config to avoid file lookups
        monkeypatch.setattr("config.loader.load_config", lambda *args: {"alerts": {"default_channel": "slack"}})
